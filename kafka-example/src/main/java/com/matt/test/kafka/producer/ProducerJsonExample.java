...
/**
 * kafka producer example, produce data which is in json
 */
public class ProducerJsonExample {

    private static String[] cityType = new String[]{"A", "B", "C", "D", "E", "F", "G"};
    private static final Logger logger = LoggerFactory.getLogger(ProducerJsonExample.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            props.put("client.id", "ProducerJsonExample");
